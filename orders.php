...
type="text" name="" value="" placeholder="Tracking ID" disabled><input 
    ...
    echo "<td scope='col' colspan='2'><a href='index.php?edit_product=".$row['product_id']."'  class='not-active'>Edit</a></td>";
            }
...
type="text" name="" value="" placeholder="Tracking ID" disabled><input 
    ...
    echo "<td scope='col' colspan='2'><a href='index.php?edit_orderstatus=".$row['order_id']."' onclick='windowScroll()'>Edit</a></td>";
            }
...
<?php 
echo "<td scope='col' colspan='2'><a href='index.php?edit_orderstatuss=".$row['order_id'].",".$row['tracking_id']."'>Edit</a></td></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>";
            }
...
type="text" name="" value="" placeholder="Tracking ID" disabled><input 
    ...
    <?php
    echo "<td scope='col' colspan='2'>Pending</td>";
    echo "<td scope='col' colspan='2'><a href='index.php?edit_orderstatus=".$row['order_id']."'>Edit</a></td>";
            }
            elseif($row['order_status']=='Shipped')
...
<a style="color:blue;"href='index.php?update_orderstatus=<?php echo $row['order_id'];?>'>(Delivered)</a></td>
<?php 
echo "<td scope='col' colspan='2'><a href='index.php?edit_orderstatuss=".$row['order_id']."'>Edit</a></td></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>";
            }
            //echo "<td>",$row['order_status'],"</td>";
           // echo "<td><a href='index.php?edit_product=".$row['product_id']."'>Edit</a></td>";
           // echo "<td><a href='delete_cat.php?delete_product=".$row['product_id']."'>Delete</a></td></tr>
